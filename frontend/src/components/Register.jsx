    ...
    return (
        <div className="glass-effect p-10 rounded-2xl shadow-plant-lg w-full max-w-md border border-plant-200">
            <div className="text-center mb-8">
                ...
                <p className="text-plant-600 mt-2 text-sm font-medium">Join CropAI today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Username Input */}
                <div>
                    <label className="block text-plant-700 font-semibold mb-2 text-sm" htmlFor="username">
                        Username
                    </label>
                    <input
                        type="text"
            ...
            <p className="mt-6 text-center text-sm text-plant-600">
                ...
                <button onClick={switchToLogin} className="text-plant-600 hover:text-plant-700 font-bold ml-1 underline decoration-2 underline-offset-2 transition-colors">
                    Login
                </button>
            </p>
        </div>
